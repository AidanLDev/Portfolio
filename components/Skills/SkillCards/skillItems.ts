...
const daviesExperienceRange: DatesUsedRange = [new Date('2020/12/01'), new Date('2024/04/01')]
const processVisionExperienceRange: DatesUsedRange = [new Date('2024/04/01'), new Date()]
...
export const frontEndSkills: ISkill[] = [
  {
    ...
    category: 'frontend',
    experienceDetails: ['2 Years Contact Partners', '4 Years Davies', currentlyUsingText],
  },
  {
    skill: 'Next',
  ...
  {
    skill: 'Angular',
    datesUsed: [contactPartnersExperienceRange, [new Date('2023/01/01'), new Date('2024/01/01')]],
    category: 'frontend',
  ...
  {
    skill: 'Redux (Toolkit)',
    datesUsed: [[new Date('2021/01/01'), new Date('2024/01/01')], processVisionExperienceRange],
    category: 'frontend',
  ...
  },
  {
    ...
    category: 'frontend',
    experienceDetails: ['2 Years at ContactPartners', '4 Years at Davies', currentlyUsingText],
  },
  {
    ...
    category: 'frontend',
    experienceDetails: ['1 Year at ContactPartners', '2 Years at Davies', currentlyUsingText],
  },
]
...
export const devOpsSkills: ISkill[] = [
  ...
  },
  {
    ...
    datesUsed: [contactPartnersExperienceRange, daviesExperienceRange],
    category: 'devops',
    experienceDetails: ['2 Years DevOps at ContactPartners', '4 Years at Davies'],
  },
  {
    skill: 'Docker',
