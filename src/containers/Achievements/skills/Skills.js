    ...
    <div>
      <h1>Skills</h1>
        <div className={styles.skillsContainer}>
          <div>
            <img src={JSLogo} height={imgHeight} width={imgWidth} alt="JavaScript Logo"/>
            <h2>JavaScript</h2>
          ...
          <div>
            <img src={ReactLogo} height={imgHeight} width={imgWidth} alt="React Logo"/>
            <h2>React</h2>
            {/* <p>The front-end framework I use within my organisation to create CMS, Callback Solutions and web applications</p> */}
          </div>
          <div>
            <img src={AngularLogo} height={imgHeight} width={imgWidth} alt="Angular Logo"/>
            <h2>Angular</h2>
          ...
          <div>
            <img src={SASSLogo} height={imgHeight} width={imgWidth} alt="SASS Logo"/>
            <h2>SASS</h2>
            {/* <p>CSS prefixing. Re-usable colour pallets/variables/mixins simplifies consistancy</p> */}
          </div>
          <div>
            <img src={NodeLogo} height={imgHeight} width={imgWidth} alt="Node Logo"/>
            <h2>Node.js</h2>
            {/* <p>Used in conjunction with Koa and Express to server secure services.</p> */}
          </div>
          <div>
            <img src={MySQLLogo} height={imgHeight} width={imgWidth} alt="MySQL Logo"/>
            <h2>MySQL</h2>
          ...
          <div>
            <img src={MongoLogo} height={imgHeight} width={imgWidth} alt="MongoDB Logo"/>
            <h2>MongoDB</h2>
            {/* <p>NoSQL alternative to traditional RDMS</p> */}
          </div>
          <div>
            <img src={AWSLogo} height={imgHeight} width={imgWidth} alt="AWS Logo"/>
            <h2>AWS</h2>
            {/* <p>The cloud platform used to host this portfolio and my organisations mission criticle applications</p> */}
          </div>
          <div>
            <img src={GitLogo} height={imgHeight} width={imgWidth} alt="Git Logo"/>
            <h2>GIT</h2>
            {/* <p></p> */}
          </div>
          <div>
            <img src={WebpackLogo} height={imgHeight} width={imgWidth} alt="Webpack Logo"/>
            <h2>Webpack</h2>
            {/* <p></p> */}
          </div>
          <div>
            <img src={DockerLogo} height={imgHeight} width={imgWidth} alt="Docker Logo"/>
            <h2>Docker</h2>
            {/* <p>TODO</p> */}
          </div>
          <div>
            <img src={SolidityLogo} height={imgHeight} width={imgWidth} alt="Solidity Logo"/>
            <h2>Solidity </h2>
