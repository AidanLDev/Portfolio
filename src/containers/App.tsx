...
const App = () => {
  ...
  const closeSideDrawer: () => void = () => setShowSideDrawer(false);
  const openSideDrawer: () => void = () => setShowSideDrawer(true);
  ...
  return (
    <div className={styles.App}>
      <header className={styles.AppHeader}>
        ...
        <nav>
          <div className={styles.mobileOnly} onClick={openSideDrawer}>
